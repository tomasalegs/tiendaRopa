...
export default function CartDrawer() {
  ...
  const validarStock = useCallback(async (): Promise<boolean> => {
    ...
    try {
      // 2. Consultar el estado actual de cada producto en Amplify Data
  ...
  const handleProceedToCheckout = async () => {
    ...
    // Si todo el stock es válido, cerramos el drawer y abrimos el modal de checkout
    setIsCartOpen(false);
  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-5 border-b border-slate-800 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 flex items-center justify-between flex-shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="text-slate-400 hover:text-cyan-400 p-1.5 rounded-lg hover:bg-slate-800 transition-colors disabled:opacity-40"
              title="Revalidar disponibilidad de stock"
              aria-label="Revalidar stock"
            >
              <svg
                className={`w-4 h-4 ${isValidating ? 'animate-spin text-cyan-400' : ''}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
        ...
        {isValidating && (
          <div className="bg-cyan-950/60 border-b border-cyan-800/50 px-4 py-2 flex items-center gap-2 text-xs text-cyan-300 animate-pulse">
        ...
        {hasIssues && !isValidating && (
          <div className="bg-rose-950/80 border-b border-rose-800/80 p-4 space-y-2.5">
            <div className="flex items-start gap-2.5">
              <div className="p-1 rounded-md bg-rose-500/20 text-rose-400 flex-shrink-0 mt-0.5">
              ...
              <div className="flex-1">
                ...
                <ul className="mt-1 space-y-1 text-[11px] text-rose-200/90 list-disc list-inside">
            ...
            <button
              ...
              className="w-full py-1.5 px-3 rounded-lg bg-rose-900/80 hover:bg-rose-800 text-white text-xs font-bold uppercase tracking-wider transition-all border border-rose-700/60 shadow flex items-center justify-center gap-1.5"
            >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {issue ? (
                        <div className="mt-1">
                          <span className="text-[10px] font-bold text-rose-400 bg-rose-950/80 px-2 py-0.5 rounded border border-rose-800/60 inline-block">
                    ...
                    <button
                      ...
                      className="text-slate-500 hover:text-red-400 p-1.5 rounded-lg hover:bg-slate-800 transition-colors flex-shrink-0"
      ...
      {/* Modal de Checkout / Transferencia Bancaria */}
      <CheckoutModal
